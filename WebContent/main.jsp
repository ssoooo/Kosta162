					...
					<div class="container">
						<div class="row">
							<div class="4u 12u(medium)">
								...
								<!-- Box -->
									<section class="box feature">
										<a href="group.html" class="image featured"><img src="images/pic01.jpg" alt="" /></a>
										<div class="inner">
											<header>
												<h2>Group1</h2></header>
											</div>
							...
							<div class="4u 12u(medium)">
								...
								<!-- Box -->
									<section class="box feature">
										<a href="group.html" class="image featured"><img src="images/pic02.jpg" alt="" /></a>
										<div class="inner">
											<header>
												<h2>Group2</h2></header>
											</div>
							...
							<div class="4u 12u(medium)">
								...
								<!-- Box -->
									<section class="box feature">
										<a href="group.html" class="image featured"><img src="images/pic03.jpg" alt="" /></a>
										<div class="inner">
												<header>
													<h2>Group3</h2>
												</header>
